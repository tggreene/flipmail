(defproject flipmail "0.1.0-SNAPSHOT"
  ...
  :profiles {:dev
             ...
             {:cljsbuild {:builds
                          {:background
                           ...
                           {:source-paths ["src/dev"
                                           "src/content_script"]
                            :compiler     {:output-to             "resources/unpacked/compiled/content_script/flipmail.js"
                                           ...
                                           :compiler-stats        true
                                           :cache-analysis        true
                                           :source-map            "resources/unpacked/compiled/content_script/flipmail.js.map"
                                           :source-map-timestamp  true}}}}}
             :checkouts
             {:cljsbuild {:builds
